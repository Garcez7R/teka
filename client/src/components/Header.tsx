    ...
    <header className="sticky top-0 z-50 bg-white border-b border-gray-200 shadow-sm">
      <div className="container flex items-center justify-between h-16">
        ...
        <Link href="/" className="flex items-center gap-2 hover:opacity-80 transition-opacity">
          <div className="w-8 h-8 bg-[#262969] rounded-lg flex items-center justify-center">
        ...
        <nav className="hidden md:flex items-center gap-8">
          <Link href="/" className="text-gray-700 hover:text-[#262969] transition-colors font-inter text-sm font-medium">
            Catálogo
          </Link>
        ...
        <div className="md:hidden">
          <button className="text-gray-700 hover:text-[#262969] transition-colors">
